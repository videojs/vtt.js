...
(function(global) {
  ...
  function CueStyleBox(window, cue, styleOptions) {
    ...
    this.move = function(box) {
      ...
      if (isIE8) {
        styles.bottom = this.formatStyle(0, "px");
      } else {
        styles.top = this.formatStyle(box.top, "px");
        styles.bottom = this.formatStyle(box.bottom, "px");
      }
  ...
  BoxPosition.prototype.toCSSCompatValues = function(reference) {
    return {
      top: (this.top - reference.top) || reference.top,
      bottom: (reference.bottom - this.bottom) || reference.bottom,
